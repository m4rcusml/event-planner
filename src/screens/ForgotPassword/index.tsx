    ...
    return (
      <ImageBackground source={BgImg} style={styles.container}>
        <View style={styles.finish}>
          ...
          <MyText variant='h2' color='darkerPrimary' align='center'>Redefinição de senha concluida com sucesso!</MyText>
  ...
  return (
    <ImageBackground source={BgImg} style={styles.container}>
      <ScrollView style={styles.form} contentContainerStyle={styles.formContent}>
        <MyText variant='h1'>Redefinir senha</MyText>
        <MyText variant='subtitle1'>Informe seu email e enviaremos um código para redefinir sua senha</MyText>
        <Field
          label='Email'
